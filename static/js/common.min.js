...
window.onload = function (){
	...
	//   fr.onload = function(){
	//     $('#preview').append($("<img>", { src: fr.result }));
	//   };
	...
	const preview = document.querySelector('.imgs-previews');
	...
	button.addEventListener('click', (e) => {
	  ...
	  // alert(
	    // JSON.stringify(fileList.map( ({ name, modified, size }) => ({ name, modified, size, data: '<[!FILEDATA]>' }) ), null, 2)
	  // );
	});
	  ...
	  [...input.files].forEach(file => {
	    ...
	    reader.addEventListener('loadend', () => {
	      ...
	      const editImg = document.createElement('button');
	            editImg.type = "button";
	            editImg.classList.add('btn-load-select-img')
	      ...
	      const remove = document.createElement('button');
	            remove.type = "button";
	            remove.classList.add('btn-del-select-img')
	            remove.innerHTML = '<svg width = "30" height = "30" viewBox = "0 0 30 30" fill = "none" xmlns = "http://www.w3.org/2000/svg" ><circle cx="15" cy="15" r="15" fill="#FF0000"/><path d="M17.4998 7.5C17.7209 7.5 17.9328 7.5878 18.0891 7.74408C18.2454 7.90036 18.3332 8.11232 18.3332 8.33333H19.9998C20.2209 8.33333 20.4328 8.42113 20.5891 8.57741C20.7454 8.73369 20.8332 8.94565 20.8332 9.16667C20.8332 9.38768 20.7454 9.59964 20.5891 9.75592C20.4328 9.9122 20.2209 10 19.9998 10H9.99984C9.77882 10 9.56686 9.9122 9.41058 9.75592C9.2543 9.59964 9.1665 9.38768 9.1665 9.16667C9.1665 8.94565 9.2543 8.73369 9.41058 8.57741C9.56686 8.42113 9.77882 8.33333 9.99984 8.33333H11.6665C11.6665 8.11232 11.7543 7.90036 11.9106 7.74408C12.0669 7.5878 12.2788 7.5 12.4998 7.5H17.4998Z" fill="white"/><path fill-rule="evenodd" clip-rule="evenodd" d="M10 10.834H20V20.834C20 21.276 19.8244 21.6999 19.5118 22.0125C19.1993 22.3251 18.7754 22.5007 18.3333 22.5007H11.6667C11.2246 22.5007 10.8007 22.3251 10.4882 22.0125C10.1756 21.6999 10 21.276 10 20.834V10.834ZM12.9167 12.5007C12.8062 12.5007 12.7002 12.5445 12.622 12.6227C12.5439 12.7008 12.5 12.8068 12.5 12.9173V20.4173C12.5 20.5278 12.5439 20.6338 12.622 20.7119C12.7002 20.7901 12.8062 20.834 12.9167 20.834C13.0272 20.834 13.1332 20.7901 13.2113 20.7119C13.2894 20.6338 13.3333 20.5278 13.3333 20.4173V12.9173C13.3333 12.8068 13.2894 12.7008 13.2113 12.6227C13.1332 12.5445 13.0272 12.5007 12.9167 12.5007ZM17.0833 12.5007C16.9728 12.5007 16.8668 12.5445 16.7887 12.6227C16.7106 12.7008 16.6667 12.8068 16.6667 12.9173V20.4173C16.6667 20.5278 16.7106 20.6338 16.7887 20.7119C16.8668 20.7901 16.9728 20.834 17.0833 20.834C17.1938 20.834 17.2998 20.7901 17.378 20.7119C17.4561 20.6338 17.5 20.5278 17.5 20.4173V12.9173C17.5 12.8068 17.4561 12.7008 17.378 12.6227C17.2998 12.5445 17.1938 12.5007 17.0833 12.5007Z" fill="white"/></svg >';
	      ...
	      editImg.addEventListener('click', function () {
	        ...
	        $('#сhange_image').on('change', function () {
	
	          let thisInput = $(this)[0]
	          ...
	          if (this.files && this.files[0]) {
	            ...
	            readerImg.onload = function (e) {
	              ...
	              [...$('#сhange_image')[0].files].forEach(file => {
	              ...
	              const newInput = thisInput.cloneNode(true);
	              // Replaceable <input> clone
	              thisInput.replaceWith(newInput);
	      ...
	      remove.addEventListener('click', (e) => {
	        ...
	        // Удаляем элемент списка (<div>) из <.imgs-previews>
	...
	$('#gallery_video_form').on('submit', function (e) {
	  ...
	  if (thisInput.value.length) {
	    ...
	    const editImg = document.createElement('button');
	          editImg.type = "button";
	          editImg.classList.add('btn-load-select-video')
	          editImg.innerHTML = '<svg width = "30" height = "30" viewBox = "0 0 30 30" fill = "none" xmlns = "http://www.w3.org/2000/svg" ><circle cx="15" cy="15" r="15" fill="currentColor"></circle><path d="M21.4873 10.987L20.1844 12.2899L17.6714 9.85386L19.0128 8.51249C19.3409 8.18435 19.7859 8 20.25 8C20.7141 8 21.1591 8.18435 21.4873 8.51249C21.8154 8.84062 21.9997 9.28568 21.9997 9.74974C21.9997 10.2138 21.8154 10.6588 21.4873 10.987ZM19.4214 13.052L11.4108 21.0626L8 22.0129L8.93538 18.589L16.9163 10.6081L19.4214 13.052Z" fill="white"></path></svg>';
	    const remove = document.createElement('button');
	          remove.type = "button";
	          remove.classList.add('btn-del-select-video')
	          remove.innerHTML = '<svg width = "30" height = "30" viewBox = "0 0 30 30" fill = "none" xmlns = "http://www.w3.org/2000/svg" ><circle cx="15" cy="15" r="15" fill="#FF0000"/><path d="M17.4998 7.5C17.7209 7.5 17.9328 7.5878 18.0891 7.74408C18.2454 7.90036 18.3332 8.11232 18.3332 8.33333H19.9998C20.2209 8.33333 20.4328 8.42113 20.5891 8.57741C20.7454 8.73369 20.8332 8.94565 20.8332 9.16667C20.8332 9.38768 20.7454 9.59964 20.5891 9.75592C20.4328 9.9122 20.2209 10 19.9998 10H9.99984C9.77882 10 9.56686 9.9122 9.41058 9.75592C9.2543 9.59964 9.1665 9.38768 9.1665 9.16667C9.1665 8.94565 9.2543 8.73369 9.41058 8.57741C9.56686 8.42113 9.77882 8.33333 9.99984 8.33333H11.6665C11.6665 8.11232 11.7543 7.90036 11.9106 7.74408C12.0669 7.5878 12.2788 7.5 12.4998 7.5H17.4998Z" fill="white"/><path fill-rule="evenodd" clip-rule="evenodd" d="M10 10.834H20V20.834C20 21.276 19.8244 21.6999 19.5118 22.0125C19.1993 22.3251 18.7754 22.5007 18.3333 22.5007H11.6667C11.2246 22.5007 10.8007 22.3251 10.4882 22.0125C10.1756 21.6999 10 21.276 10 20.834V10.834ZM12.9167 12.5007C12.8062 12.5007 12.7002 12.5445 12.622 12.6227C12.5439 12.7008 12.5 12.8068 12.5 12.9173V20.4173C12.5 20.5278 12.5439 20.6338 12.622 20.7119C12.7002 20.7901 12.8062 20.834 12.9167 20.834C13.0272 20.834 13.1332 20.7901 13.2113 20.7119C13.2894 20.6338 13.3333 20.5278 13.3333 20.4173V12.9173C13.3333 12.8068 13.2894 12.7008 13.2113 12.6227C13.1332 12.5445 13.0272 12.5007 12.9167 12.5007ZM17.0833 12.5007C16.9728 12.5007 16.8668 12.5445 16.7887 12.6227C16.7106 12.7008 16.6667 12.8068 16.6667 12.9173V20.4173C16.6667 20.5278 16.7106 20.6338 16.7887 20.7119C16.8668 20.7901 16.9728 20.834 17.0833 20.834C17.1938 20.834 17.2998 20.7901 17.378 20.7119C17.4561 20.6338 17.5 20.5278 17.5 20.4173V12.9173C17.5 12.8068 17.4561 12.7008 17.378 12.6227C17.2998 12.5445 17.1938 12.5007 17.0833 12.5007Z" fill="white"/></svg >';
